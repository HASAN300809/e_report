    ...
    ?>
       ...
       <form action="" method="post">
         <div class="avatar">
          ...
          <div class="form-group">
             	<input type="text" class="form-control" name="name_user" placeholder="Nama Lengkap" required="required">
          </div>
          <div class="form-group">
        ...
        <p class="text-center small">Don't have an account? <a href="login.php">Sign up here!</a></p>
